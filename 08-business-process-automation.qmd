...
![How AI Tools Are Used in Business Process Automation and RPA is one area where AI tools are changing business and IT work.](images/08/hero.png){#fig-hero fig-alt="Illustration introducing How AI Tools Are Used in Business Process Automation and RPA with abstract business and technology elements." width="100%"}
<!-- imagegen:end -->
...
<!-- imagegen:begin slug=the-basic-vocabulary -->
![The basic vocabulary is a practical part of AI use in business and IT.](images/08/the-basic-vocabulary.png){#fig-the-basic-vocabulary fig-alt="Illustration of The basic vocabulary using abstract business and technology symbols." width="80%"}
<!-- imagegen:end -->
...
<!-- imagegen:begin slug=process-mining-and-task-mining-finding -->
![Process mining and task mining: finding what to automate is a practical part of AI use in business and IT.](images/08/process-mining-and-task-mining-finding.png){#fig-process-mining-and-task-mining-finding fig-alt="Illustration of Process mining and task mining: finding what to automate using abstract business and technology symbols." width="80%"}
<!-- imagegen:end -->
...
<!-- imagegen:begin slug=why-businesses-use-ai-automation -->
![Why businesses use AI automation is a practical part of AI use in business and IT.](images/08/why-businesses-use-ai-automation.png){#fig-why-businesses-use-ai-automation fig-alt="Illustration of Why businesses use AI automation using abstract business and technology symbols." width="80%"}
<!-- imagegen:end -->
